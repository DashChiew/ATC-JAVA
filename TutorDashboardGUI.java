...
import com.tutorapp.utils.FileUtil;
...
public class TutorDashboardGUI extends JFrame {
    ...
    private loginPageTest loginPage; // Reference to the login page

    // Constructor to accept username and the login page instance
    public TutorDashboardGUI(String tutorUsername, loginPageTest loginPage) {
