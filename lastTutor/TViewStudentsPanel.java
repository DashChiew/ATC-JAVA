...
public class TViewStudentsPanel extends JPanel {
    ...
    private static final String ENROLMENT_FILE = "C:\\Users\\User\\IdeaProjects\\tt\\src\\student_enrollment.txt"; // Defined here for this class's scope
    ...
    public TViewStudentsPanel(String tutorUsername) {
        ...
        // Modified columnNames to exclude "Tutor Name"
        String[] columnNames = {"Student ID", "Student Name", "Form", "Subjects"};
        ...
        studentTable.getColumnModel().getColumn(3).setPreferredWidth(300); // Subjects is now at index 3
    ...
    private void displayStudents(String filterFormLevel) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(ENROLMENT_FILE))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                // Ensure there are enough parts for the expected data (at least up to subjects)
                // Removed the condition '&& parts[8].equals(currentTutor)'
                if (parts.length >= 7) {
            ...
            if (!found && studentTableModel.getRowCount() == 0) {
                // Modified message to reflect the displayed columns
                studentTableModel.addRow(new Object[]{"No students found.", "", "", ""});
            }
