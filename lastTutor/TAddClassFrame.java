// File: src/main/java/com/tutorapp/ui/frames/TAddClassFrame.java
...
public class TAddClassFrame extends JFrame {
    private JTextField subjectField, chargesField, scheduleField;
    private JComboBox<String> formLevelComboBox;

    private static final String SUBJECTS_FILE = "C:\\Users\\User\\IdeaProjects\\tt\\src\\subjects.txt";

    public TAddClassFrame(String tutorUsername) {
    ...
    private void addClass() {
        ...
        try {
            ...
            try (FileWriter fw = new FileWriter(SUBJECTS_FILE, true);
                ...
                bw.write(subject + "," + formLevel + "," + charges + "," + schedule + "\n");
