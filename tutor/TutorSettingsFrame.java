// File: src/main/java/com/tutorapp/ui/frames/TutorSettingsFrame.java
...
import com.tutorapp.utils.FileUtil; // Using FileUtil for image placeholder
...
public class TutorSettingsFrame extends JFrame {
    ...
    public TutorSettingsFrame(String tutorUsername) {
    ...
    private void loadTutorData() {
        String[] data = TeacherProfileManager.getTutorProfileData(tutorUsername);
    ...
    private void saveProfile() {
        ...
        boolean success = TeacherProfileManager.updateTutorProfile(
