...
public class MainPayment extends javax.swing.JFrame {
    ...
    private ProfilePageGUI profilePageGUI;
    ...
    private Student studentData; // NEW: Field to hold the Student object


    /**
     * Creates new form MainPayment
     *
     * @param profilePageGUI The instance of ProfilePageGUI that opened this frame.
     * @param student The Student object for which payments are being displayed.
     */
    // MODIFIED: Constructor now accepts ProfilePageGUI and Student
    public MainPayment(ProfilePageGUI profilePageGUI, Student student) {
        System.out.println("MainPayment: Parameterized constructor (ProfilePageGUI, Student) initialized.");
        this.profilePageGUI = profilePageGUI;
        this.studentData = student; // Store the student data
    ...
    private void initializeUserData() {
        if (studentData != null && studentData.getStudentId() != null) {
            this.currentUsername = studentData.getStudentId();
        } else {
    ...
    private void returnButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (profilePageGUI != null) {
            profilePageGUI.setVisible(true);
        } else {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        new Payment(this, totalUnpaidAmount).setVisible(true); // Pass the totalUnpaidAmount
    }
