...
public class SProfilePageGUI extends JFrame {
    ...
    public SProfilePageGUI(MainLoginPageTest MainLoginPageTest) {
    ...
    private void loadAndRefreshStudentData(String studentId) {
        ...
        Map<String, SStudent> allStudents = SettingForStudent.readEnrollmentData(STUDENT_ENROLLMENT_FILE);
        SettingForStudent.readStudentLoginData(STUDENTS_FILE, allStudents);

        loggedInSStudent = allStudents.get(studentId);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            MainLoginPageTest MainLoginPageTest = null;
            new SProfilePageGUI(MainLoginPageTest);
        });
    }
}