...
public class SMainPayment extends javax.swing.JFrame {
     ...
     */
// Inside SMainPayment.java

    private void initializeUserData() {
        if (SStudentData != null && SStudentData.getLoginUsername() != null) { // CHANGE HERE: Use getLoginUsername()
            this.currentUsername = SStudentData.getLoginUsername(); // CHANGE HERE: Use getLoginUsername()
        } else {
        ...
        if (SStudentData != null) {
            System.out.println("MainPayment: SStudentData Student ID: " + SStudentData.getStudentId()); // Keep this for context
            System.out.println("MainPayment: SStudentData Login Username: " + SStudentData.getLoginUsername()); // Add this for clarity
        }
    }
