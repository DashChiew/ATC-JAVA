...
public class SStudent {
    private String studentId; // This will be the ID from student_enrollment.txt (e.g., "083521")
    private String name;
    ...
    private String role;
    private String loginUsername; // Field for the username from students.txt (e.g., "S001")
    ...
    public SStudent(String studentId, String name, String icPassport, String email, String contactNumber, String address, String formLevel, String subjects, String enrollmentMonth) {
        ...
        this.loginUsername = ""; // Initialize the new field
    }
